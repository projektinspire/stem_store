...
if (isset($_GET['id'])) {
    $customerID = intval($_GET['id']); // Sanitize input
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $VRN = $_POST['VRN'];
    $LPO = isset($_POST['LPO']) ? $_POST['LPO'] : null; // Optional LPO field
    $customerID = intval($_POST['customerID']); // Sanitize input

    // Prepare and execute the update statement, including LPO
    $sql = "UPDATE customers SET CustomerName=?, TINNumber=?, VRN=?, LPO=? WHERE CustomerID=?";
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("ssssi", $customerName, $TINNumber, $VRN, $LPO, $customerID);
...
<!-- HTML Form for editing the customer -->
  ...
  <div class="row w-100">
    <div class="col-lg-6 col-md-8 col-sm-10 mx-auto">
      <div class="card">
        ...
        <div class="card-body">
          <form method="POST" action="edit_customer.php?id=<?php echo htmlspecialchars($customer['CustomerID']); ?>">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="customerName" name="customerName" value="<?php echo htmlspecialchars($customer['CustomerName']); ?>" required>
            </div>

            <!-- TIN Number -->
            <div class="form-group">
              <label for="TINNumber">TIN Number</label>
              <input type="text" class="form-control" id="TINNumber" name="TINNumber" value="<?php echo htmlspecialchars($customer['TINNumber']); ?>" required>
            </div>

            <!-- VRN -->
            <div class="form-group">
              <label for="VRN">VRN</label>
              <input type="text" class="form-control" id="VRN" name="VRN" value="<?php echo htmlspecialchars($customer['VRN']); ?>" required>
            </div>

            <!-- LPO (Optional) -->
            <div class="form-group">
              <label for="LPO">LPO (Optional)</label>
              <input type="text" class="form-control" id="LPO" name="LPO" value="<?php echo htmlspecialchars($customer['LPO']); ?>">
            </div>
