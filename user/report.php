...
// Display primary information for reports
function displayReportLinks($period) {
    $year = getCurrentYear();
    echo "<ul class='list-group'>";
    echo "<li class='list-group-item border-0 d-flex justify-content-between ps-0 mb-2 border-radius-lg'>";
    echo "<div class='d-flex flex-column'>";
    echo "<h6 class='mb-1 text-dark font-weight-bold text-sm'>{$period} Report</h6>";
    echo "<span class='text-xs'>Year: {$year}</span>";
    echo "</div>";
    echo "<div class='d-flex align-items-center text-sm'>";
    echo "<a href='../reports/report.php?period={$period}&year={$year}' class='btn btn-link text-dark text-sm mb-0 px-0 ms-4'>";
    echo "<i class='fas fa-file-pdf text-lg me-1'></i> PDF";
    echo "</a>";
    echo "</div>";
    echo "</li>";
    echo "</ul>";
...
<div class="col-lg-4">
    <div class="card h-100">
        ...
        <div class="card-body p-3 pb-0">
            <?php
            // Display report links for daily, weekly, and annual reports
            displayReportLinks('Daily');
            displayReportLinks('Weekly');
            displayReportLinks('Annual');
            ?>
        </div>
    </div>
</div>
