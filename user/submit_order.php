...
if (isset($_POST['submit'])) {
    ...
    if (empty($_POST['customerID'])) {
        echo "<script>alert('Store keeper is not selected.'); window.location.href = 'Dashboard.php';</script>";
        exit;
    }
    ...
    if (isset($_POST['totalPrice'], $_POST['cartItems'])) {
        ...
        if (!$cartItems || empty($cartItems)) {
            echo "<script>alert('Cart is empty. Please add items to cart.'); window.location.href = 'Dashboard.php';</script>";
            exit;
        }
        ...
        echo "<script>setTimeout(function(){ window.location.href = 'Dashboard.php'; }, 4000);</script>";
    } else {
        echo "<script>alert('Error: Required fields are missing.'); setTimeout(function(){ window.location.href = 'Dashboard.php'; }, 2000);</script>";
    }
}
