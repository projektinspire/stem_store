...
<!-- Continue with your HTML code to display the table -->
              ...
              <tbody>
                ...
                if ($result->num_rows > 0) {
                  ...
                  while($row = $result->fetch_assoc()) {
                    echo "<tr>";
                    echo "<td><p class='text-xs font-weight-bold mb-0'>" . htmlspecialchars($row['id']) . "</p></td>";
                    echo "<td><p class='text-xs font-weight-bold mb-0'>" . htmlspecialchars($row['username']) . "</p></td>";
                    echo "<td><p class='text-xs font-weight-bold mb-0'>" . htmlspecialchars($row['email']) . "</p></td>";
                    echo "<td><p class='text-xs font-weight-bold mb-0'>" . htmlspecialchars($row['password']) . "</p></td>";
