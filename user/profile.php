...
$query = "SELECT username, email, role, password FROM users WHERE id = ?";
...
<body class="g-sidenav-show bg-gray-100">
  ...
  <ul class="navbar-nav">
    ...
    <li class="nav-item">
      <a class="nav-link" href="../user/sales.php">
        <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
...
<div class="card shadow-lg mx-4 card-profile-bottom">
    ...
    <dotlottie-player src="https://lottie.host/286ddacb-5a20-4a44-96a3-8443ed2609fd/oLGql33CFO.json" background="transparent" speed="1" style="width: 300px; height: 300px;" loop autoplay></dotlottie-player>
</div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="password" id="password" name="password" value="<?php echo htmlspecialchars($user['password']); ?>" required>
                                </div>
                            </div>
                            <!-- Role Dropdown -->
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="role" id="role" class="form-control" required>
                                        ...
                                        <option value="Store Keeper" <?php echo ($user['role'] === 'Store Keeper') ? 'selected' : ''; ?>>Store Keeper</option>
