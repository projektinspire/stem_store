                        ...
                        <form method="POST" action="edit_product.php?id=<?php echo htmlspecialchars($product['ID']); ?>" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select class="form-control" id="prod_cat" name="prod_cat">
                                    ...
                                    <option value="Stationery" <?php echo ($product['prod_cat'] == 'Stationery') ? 'selected' : ''; ?>>Stationery</option>
                                    <option value="Electronics" <?php echo ($product['prod_cat'] == 'Electronics') ? 'selected' : ''; ?>>Electronics</option>
                                    <option value="Chemistry Tools" <?php echo ($product['prod_cat'] == 'Chemistry Tools') ? 'selected' : ''; ?>>Chemistry Tools</option>
                                    <option value="Engineering Devices" <?php echo ($product['prod_cat'] == 'Engineering Devices') ? 'selected' : ''; ?>>Engineering Devices</option>
                                    <option value="Kitchen Equipment" <?php echo ($product['prod_cat'] == 'Kitchen Equipment') ? 'selected' : ''; ?>>Kitchen Equipment</option>
                                </select>
                            </div>
